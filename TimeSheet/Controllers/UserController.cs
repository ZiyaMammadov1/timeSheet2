...
//        //[HttpGet]
//        //[Route("test")]
//        //public ActionResult<Answer<Position>> Check([FromBody]UserPostDto UserPostDto)
//        //{
//        //    Helper.CheckDatabase<Position> ch = new Helper.CheckDatabase<Position>(_context);
//        //    return ch.Exist(x => x.uuid == UserPostDto.positionCode);
//        //}
//    }
//}
