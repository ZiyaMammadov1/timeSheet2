...
namespace TimeSheet.Migrations
{
    ...
    [Migration("20220708070414_AddRequestTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeSheet.Entities.Request", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TimeSheet.Entities.RequestType", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TimeSheet.Entities.Status", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TimeSheet.Entities.Request", b =>
                {
                    ...
                    b.HasOne("TimeSheet.Entities.RequestType", "RequestType")
                        .WithMany()
                        .HasForeignKey("requestTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TimeSheet.Entities.Status", "Status")
                        .WithMany()
